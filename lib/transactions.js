...
/**
 * Default number of transactions returned per page.
 *
 * @type {10}
 */
...
/**
 * Shared Prisma select object for transaction reads with related category data.
 */
...
/**
 * Returns the date boundaries for predefined transaction filter periods.
 *
...
/**
 * Builds the effective date filter object for transaction queries.
 *
 * @param {{ period?: string, from?: Date | string | null, to?: Date | string | null }} filters
...
/**
 * Maps UI sort keys to Prisma `orderBy` clauses.
 *
 * @param {"date_desc" | "date_asc" | "amount_desc" | "amount_asc" | undefined} sort
...
/**
 * Converts a Prisma transaction record into a JSON-safe API payload.
 *
 * @param {{
 *   id: string,
 *   type: string,
