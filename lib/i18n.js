...
const messages = {
  en: {
    ...
    importExport: {
      ...
      importConfirmDescription:
        "All current categories, transactions, budgets, goals, and related tracker data will be removed. After that, data from the uploaded CSV file will be imported instead.",
  ...
  uk: {
    ...
    common: {
      ...
      signOutConfirmDescription:
        "Поточна сесія завершиться, і вас буде повернуто на сторінку входу.",
      signOutConfirmCancel: "Залишитися в акаунті",
      signOutConfirmAction: "Вийти",
      apply: "Застосувати",
    ...
    importExport: {
      ...
      importConfirmDescription:
        "Усі поточні категорії, транзакції, ліміти, цілі та пов’язані дані трекера буде видалено. Після цього замість них буде імпортовано дані із завантаженого CSV-файлу.",
